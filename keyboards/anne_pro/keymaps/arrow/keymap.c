...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
      ...
      KC_LCTL, MO(_ANNE), KC_LALT,                 KC_SPACE,                                    KC_LEFT, KC_DOWN, KC_RGHT, MO(_FN)
  ),
  [_FN] = LAYOUT(
      ...
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(_BT), XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_SLSH,                   _______,

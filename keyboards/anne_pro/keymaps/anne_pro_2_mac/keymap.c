...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
      ...
      KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPACE,                  KC_LALT, LT(_FN,KC_LEFT), LT(_ANNE,KC_DOWN), MT(MOD_RCTL, KC_RGHT)
  ),
  [_FN] = LAYOUT(
  ...
  [_ANNE] = LAYOUT(
      QK_BOOT, KC_MSTP, KC_VOLD, KC_VOLU, KC_MRWD, KC_MPLY, KC_MFFD, KC_MUTE, XXXXXXX, APL_MOD, APL_RGB, APL_RAT, APL_BRT, XXXXXXX,
  ...
  [_BT] = LAYOUT(
      TG(_BT), APB_HC1, APB_HC2, APB_HC3, APB_HC4, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, APB_LGC, APB_OFF, APB_ON,  XXXXXXX,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPACE,                  KC_RALT, LT(_FN,KC_LEFT), LT(_ANNE,KC_DOWN), MT(MOD_RCTL, KC_RGHT)
  ),
  [_FN] = LAYOUT(
  ...
  [_ANNE] = LAYOUT(
      QK_BOOT, KC_MSTP, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, XXXXXXX, APL_MOD, APL_RGB, APL_RAT, APL_BRT, XXXXXXX,
